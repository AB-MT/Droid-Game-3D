...
class GUI:
    def __init__(self, username, rating, status, rootParent=None):
        ...
        self.pg6567 = DirectLabel(
            frameSize=(-1.15, 5.25, -2.113, 0.725),
        ...
        self.pg6567.setTransparency(0)

        self.pg8153 = DirectScrolledList(
            forceHeight=0.1,
        ...
        self.pg8153.setTransparency(0)

        self.pg8745 = DirectScrolledListItem(
        ...
        self.pg8745.setTransparency(0)

        self.pg8767 = DirectScrolledListItem(
            frameSize=LVecBase4f(-3.83125, 3.90625, -0.2125, 0.85),
            hpr=LVecBase3f(0, 0, 0),
        ...
        self.pg8767.setTransparency(0)

        self.pg8153.addItem(self.pg8745)
        self.pg8153.addItem(self.pg8767)
